            ...
            <div className={classes.formContainer}>
              ...
              >
                <TextField
                  ...
                  onChange={event =>
                    props.inputChangedHandler(event, "fullName")
                  }
                  margin="normal"
                  variant="outlined"
                  required
                ...
                <TextField
                  ...
                  onChange={event =>
                    props.inputChangedHandler(event, "password")
                  }
                  margin="normal"
                  variant="outlined"
                  required
                ...
                <TextField
                  ...
                  placeholder="John-Doe-123"
                  type={props.toogleViewPassword ? "text" : "password"}
                  value={props.authSignUpForm.confirmPassword.value}
                  onChange={event =>
                  ...
                  required
                  error={
                    !props.authSignUpForm.confirmPassword.valid &&
                    props.authSignUpForm.confirmPassword.touched
                  }
                  helperText={
                    !props.authSignUpForm.confirmPassword.valid &&
                    props.authSignUpForm.confirmPassword.touched
